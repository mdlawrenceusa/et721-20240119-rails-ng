...
class PresidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create president" do
    assert_difference("President.count") do
      post presidents_url, params: { president: { comment: @president.comment, image_url: @president.image_url, name: @president.name } }
    end
  ...
  test "should update president" do
    patch president_url(@president), params: { president: { comment: @president.comment, image_url: @president.image_url, name: @president.name } }
